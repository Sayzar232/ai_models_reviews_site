...
from backend.parse_hf import parse_hf_models
...
REVIEWS_DATA = [
    # ChatGPT reviews
    {"user_idx": 0, "model_idx": 0, "overall": 8.5, "coding": 8.0, "speed": 7.5, "value": 5.0, "context": 9.0, "creative": 9.0, "accuracy": 8.5,
    ...
    {"user_idx": 1, "model_idx": 0, "overall": 8.0, "coding": 7.5, "speed": 7.0, "value": 4.5, "context": 9.0, "creative": 8.5, "accuracy": 8.0,
     ...
     "tags": ["Использую в работе"]},
    {"user_idx": 2, "model_idx": 0, "overall": 9.0, "coding": 9.0, "speed": 8.0, "value": 6.0, "context": 9.5, "creative": 9.5, "accuracy": 8.0,
    ...
    # Claude reviews
    {"user_idx": 0, "model_idx": 1, "overall": 9.0, "coding": 9.5, "speed": 7.0, "value": 5.5, "context": 9.5, "creative": 8.5, "accuracy": 9.5,
     ...
     "tags": ["Использую в работе"]},
    {"user_idx": 1, "model_idx": 1, "overall": 9.5, "coding": 9.5, "speed": 7.5, "value": 6.0, "context": 9.5, "creative": 8.0, "accuracy": 9.5,
     ...
     "tags": ["Использую в работе"]},
    {"user_idx": 3, "model_idx": 1, "overall": 8.5, "coding": 8.5, "speed": 7.0, "value": 5.0, "context": 8.0, "creative": 8.0, "accuracy": 9.0,
    ...
    # Gemini reviews
    {"user_idx": 0, "model_idx": 2, "overall": 7.5, "coding": 7.0, "speed": 9.0, "value": 8.0, "context": 8.0, "creative": 7.5, "accuracy": 7.0,
     ...
     "tags": ["Тестировал"]},
    {"user_idx": 2, "model_idx": 2, "overall": 7.0, "coding": 6.5, "speed": 9.5, "value": 9.0, "context": 8.5, "creative": 7.0, "accuracy": 6.5,
    ...
    {"user_idx": 4, "model_idx": 2, "overall": 8.0, "coding": 7.0, "speed": 9.0, "value": 9.0, "context": 8.5, "creative": 8.0, "accuracy": 7.5,
    ...
    # Grok reviews
    {"user_idx": 0, "model_idx": 3, "overall": 7.0, "coding": 6.5, "speed": 8.0, "value": 6.0, "context": 7.0, "creative": 9.0, "accuracy": 6.5,
     ...
     "tags": ["Тестировал"]},
    {"user_idx": 3, "model_idx": 3, "overall": 7.5, "coding": 6.0, "speed": 8.0, "value": 5.0, "context": 7.0, "creative": 9.5, "accuracy": 7.0,
    ...
    # Mistral reviews
    {"user_idx": 1, "model_idx": 4, "overall": 7.5, "coding": 7.0, "speed": 8.0, "value": 7.0, "context": 7.5, "creative": 7.0, "accuracy": 8.0,
     ...
     "tags": ["Тестировал"]},
    {"user_idx": 4, "model_idx": 4, "overall": 7.0, "coding": 6.0, "speed": 8.0, "value": 7.5, "context": 7.0, "creative": 7.0, "accuracy": 7.5,
    ...
    # Llama reviews
    {"user_idx": 0, "model_idx": 5, "overall": 8.0, "coding": 7.5, "speed": 8.5, "value": 10.0, "context": 8.0, "creative": 7.0, "accuracy": 7.5,
     ...
     "tags": ["Использую в работе"]},
    {"user_idx": 1, "model_idx": 5, "overall": 7.5, "coding": 7.0, "speed": 8.0, "value": 10.0, "context": 8.5, "creative": 6.5, "accuracy": 7.0,
    ...
    # DeepSeek reviews
    {"user_idx": 0, "model_idx": 6, "overall": 8.5, "coding": 9.0, "speed": 8.0, "value": 10.0, "context": 8.5, "creative": 7.5, "accuracy": 8.5,
     ...
     "tags": ["Использую в работе"]},
    {"user_idx": 2, "model_idx": 6, "overall": 8.0, "coding": 8.5, "speed": 7.5, "value": 10.0, "context": 7.5, "creative": 7.0, "accuracy": 8.0,
     ...
     "tags": ["Использую в работе"]},
    {"user_idx": 3, "model_idx": 6, "overall": 8.0, "coding": 8.0, "speed": 7.0, "value": 9.5, "context": 7.5, "creative": 7.5, "accuracy": 8.0,
    ...
    # Qwen reviews
    {"user_idx": 1, "model_idx": 7, "overall": 7.0, "coding": 7.0, "speed": 8.0, "value": 8.5, "context": 7.5, "creative": 6.5, "accuracy": 7.0,
     ...
     "tags": ["Тестировал"]},
    {"user_idx": 4, "model_idx": 7, "overall": 6.5, "coding": 6.0, "speed": 7.5, "value": 8.0, "context": 7.0, "creative": 6.5, "accuracy": 6.5,
...
async def seed():
    ...
    if existing and existing["cnt"] > 0:
        print("[SKIP] Data already exists, skipping main seed part")
    ...
    print(f"[OK] Inserted {len(MODELS_DATA)} models")
    ...
    print(f"[OK] Inserted {len(USERS_DATA)} users")
    ...
    for r in REVIEWS_DATA:
        ...
        await execute(
            ...
            """,
            user_id, model_id,
            r["overall"], r["coding"], r["speed"], r["value"],
            r["context"], r["creative"], r["accuracy"],
            r["text"], tags_json,
        )
    print(f"[OK] Inserted {len(REVIEWS_DATA)} reviews")

    # Recalculate stats for all models
    for m in models:
        await recalculate_model_stats(m["id"])
    print("[OK] Model stats recalculated")
